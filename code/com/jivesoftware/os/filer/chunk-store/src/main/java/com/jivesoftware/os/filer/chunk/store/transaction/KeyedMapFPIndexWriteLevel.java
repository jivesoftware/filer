 ...
 */
public class KeyedMapFPIndexWriteLevel implements LevelProvider<ChunkStore, KeyedFPIndex<Integer>, ChunkStore, Integer, MapBackedKeyedFPIndex> {

    private final LocksProvider<Integer> locksProvider;
    private final boolean variableSizedKeys;

    public KeyedMapFPIndexWriteLevel(LocksProvider<Integer> locksProvider, boolean variableSizedKeys) {
    ...
    public <R> R enter(ChunkStore chunkStore,
        ...
        MapCreator creator = new MapCreator(1, keySize, variableSizedKeys, 8, false);

        return MapTransactionUtil.INSTANCE.write(chunkStore, creator, 1, parentStore, locksProvider, keySize, MapOpener.DEFAULT, chunkStore,
