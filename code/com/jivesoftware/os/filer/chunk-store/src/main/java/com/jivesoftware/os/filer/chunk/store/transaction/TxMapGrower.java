...
public class TxMapGrower {
    ...
    public static final TxNamedMapOfFilerOverwriteGrowerProvider<Integer, MapContext> MAP_OVERWRITE_GROWER =
        new TxNamedMapOfFilerOverwriteGrowerProvider<Integer, MapContext>() {

            @Override
            public GrowFiler<Integer, MapContext, ChunkFiler> create(final Integer hint) {
                return new MapGrower(hint);
            }
        };
    ...
    public static final TxNamedMapOfFilerRewriteGrowerProvider<Integer, MapContext> MAP_REWRITE_GROWER =
        new TxNamedMapOfFilerRewriteGrowerProvider<Integer, MapContext>() {
            ...
            public <R> GrowFiler<Integer, MapContext, ChunkFiler> create(final Integer hint,
                ...
                final MapGrower mapGrower = new MapGrower(hint);
