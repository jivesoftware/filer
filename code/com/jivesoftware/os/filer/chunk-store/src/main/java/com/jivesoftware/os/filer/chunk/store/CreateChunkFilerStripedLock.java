 ...
 */
public class CreateChunkFilerStripedLock implements CreateFiler<Long, FilerLock, ChunkFiler> {

    private final FPStripingLocksProvider filerLocks;

    public CreateChunkFilerStripedLock(FPStripingLocksProvider filerLocks) {
    ...
    @Override
    public FilerLock create(Long hint, ChunkFiler filer) throws IOException {
